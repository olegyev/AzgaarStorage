...
public class WebAppConfig implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) {
        servletContext
                .addFilter("springSessionRepositoryFilter", DelegatingFilterProxy.class)
    ...
    @Bean
    public SessionRepositoryFilter<?> springSessionRepositoryFilter(MapSessionRepository sessionRepository) {
        ...
        springSessionRepositoryFilter.setHttpSessionIdResolver(cookieHttpSessionIdResolver);
